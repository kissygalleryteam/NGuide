...
KISSY.config({
    packages: [{
        name: "kg/offline/1.1/index",
        path: "http://a.tbcdn.cn/s/kissy/",
        charset: "utf-8"
    }]
});
KISSY.add('kg/NGuide/2.0.0/index',function (S, Node, Base, Xtpl, Offline) {
    var EMPTY = '';
    var $ = Node.all;
    /**
     * 请修改组件描述
    ...
    function NGuide(cfg) {
        ...
        self.topDist = 2.0.0; // 窗口需滚动时，浮层距离窗口顶部的距离
    ...
    return NGuide;
}, {requires:['node', 'base', "xtemplate", "kg/offline/1.1/index"]});
